...
def associate_population_cells_file(self, population, csv_suffix):
    original_file_name = f"{csv_suffix}_{population.name}.csv"
    original_file_path = os.path.join(self.storage_path, original_file_name)
    if os.path.exists(original_file_path):
        ...
        new_file_path = move_file(
            original_file_path,
            os.path.join(population.storage_path, population.id),
            new_file_name
        )
