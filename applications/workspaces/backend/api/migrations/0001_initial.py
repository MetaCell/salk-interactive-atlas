# Generated by Django 3.2.11 on 2022-03-21 13:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_method', models.CharField(choices=[('email', 'Email')], default='email', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('atlas', models.CharField(choices=[('slk10', 'Salk cord 10um'), ('aln20', 'Allen cord 20um')], default='slk10', max_length=5)),
