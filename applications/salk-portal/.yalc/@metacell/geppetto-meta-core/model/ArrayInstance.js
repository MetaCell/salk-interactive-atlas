...
var ArrayInstance = /*#__PURE__*/function (_Instance) {
  _inherits(ArrayInstance, _Instance);
  ...
  function ArrayInstance(options) {
    ...
    _classCallCheck(this, ArrayInstance);

    _this = _super.call(this, options);
    _this.size = options.size;
    _this.length = options.size;
    return _this;
  }

  _createClass(ArrayInstance, [{
    key: "getConnections",
...
//# sourceMappingURL=ArrayInstance.js.map